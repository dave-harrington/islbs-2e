...
The study team enrolled children in the United Kingdom between 2006 and 2009, selecting  640 infants between  4  and  11  months old who had eczema, an egg allergy, or both. Each child was randomly assigned to one of two groups: the peanut consumption (the treatment group)  or  peanut avoidance (the control group). Children in the treatment group were fed at least 6 grams (g) of peanut protein daily until 5 years of age, while children in the control group avoided peanut protein during the same period.   To detect a peanut allergy at age five, each child underwent an oral food challenge (OFC) --  consuming 5g of peanut protein. In the data collection, "PASS" was used to indicate no allergic reaction, while a "FAIL" indicated an allergic reaction.

The response and explanatory variables were the OFC outcome and peanut content of the child's diet.

The LEAP [data](http://openintrostat.github.io/openintro/reference/LEAP.html) data are available in the [**openintro**](http://openintrostat.github.io/openintro) R package. Individual-level data from are shown in @tbl-leap-study-results-df. Each row represents a participant, showing their `participant.ID`, `treatment.group`, and `overall.V60.outcome` (OFC result at 60 months). 
...
A gardener wants to test two fertilizers for rose bushes on her 12 $\times$ 12 meter plot. She plans to organize the garden in a checkerboard pattern of 16 3 $\times$ 3 meter squares, with two square plots with and without bushes in each row.   She has noted in the past that some of the rows get less sun because of a nearby shade tree
...
An outpatient clinic plans to test a new method of insuring its physician assistants (PAs) accurately complete vital signs and symptom measurements. Currently, PAs attend a training session for one of four specialties, see patients after passing an exam, and use a specialized checklist. The hospital considers eliminating the training session and equipping PAs with a standardized electronic checklist on tablets that can use software to check errors.

Each June, the organization hires 80 new PAs and assigns to their program of choice.  Typically at least 16 elect each of the specialties.

Describe how the principles experimental design might be used to evaluate the new checklist. Specify a question of interest and the response and explanatory variables.

------------------------------------------

The question of interest might be how do the error rates assessing signs and symptoms compare for PAs who underwent training versus those using the checklist. The response and explanatory variables might be whether or not a PA conducted a complete, accurate assessment of signs and symptoms and the use of the checklist.
...
Observational studies should be based on a specific question about the relationship between a response and explanatory variables and use designs that minimize bias and reduce uncertainty. Guidelines for the design of observational studies are similar to the principles of experimental design, but with some important modifications.

1. **Control.**  Control in the design of an observational study is similar to control in an experiment.  The study data should be restricted to the population of interest.  The Du Toit study recorded peanut allergies in questionnaires given to primary and secondary school children in Jewish schools in greater London and schools in Tel Aviv, Israel.  The two populations were chosen because of an assumed similar genetic makeup.  Children completing the allergy questionnaire lived in similar environments: North London and the Mehoz Merkaz Region of Tel Aviv.  The dietary questionnaire was administered to Israeli parents of infants age 14 - 24 months. In the UK clinical guidelines recommended the avoidance of peanut products for all infants, so no questionnaire was needed. 

2. **Recording confounders.**  Since randomization will not be used to balance (on average) potential confounders across levels of explanatory, it is important to consider in advance which confounders should either be measured or used in an existing dataset. The study team in UK/Israeli peanut allergy study recorded the age and sex of the participating primary school children as well as the presence of egg/milk allergies. Statistical models discussed in later chapters provide methods for estimating relationships in observational studies in the presence of confounders.

3. **Replication.**  Larger datasets are  better than smaller ones, so observational data should contain enough measurements on the response and explanatory variables to reduce uncertainty in the results of analyses.  There is an important caveat about study size in observational studies. If confounding is causing bias in an observed relationship, more data collected with the same design will not fix the problem; it will simply make a wrong answer appear more certain.  (NEED AN EXAMPLE OF THIS BEFORE WE GET TO SURVEYS, WHERE THE POINT CAN BE MADE WITH AXIOS VERSUS FACEBOOK.)

4. **Stratification.**  Stratifying a population into relatively homogeneous groups reduces variability and may lead to more interpretable results. The Du Toit study did not stratify during data collection but did analyze the results from primary school children separately. In the DDS data, the apparent strong relationship between expenditures and consumer race disappeared when the consumer population was stratified by age.  The Portland tree inventory project stratified its data collection by classifying the trees as street versus park trees.  
