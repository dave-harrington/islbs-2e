...
```{r lotp-general}
#| label: fig-lotp-general
#| out-width: 80%
#| fig-cap: |
#|   Diagram illustrating how to solve for the probability of an event B by breaking the event into disjoint events according to another event, E.  
#| fig-alt: |
...
#| fig-pos: H
knitr::include_graphics("images/lotp_general.png")
```
