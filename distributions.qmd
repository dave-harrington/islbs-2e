...
The formula easily generalizes to a sum of any number of random variables.
...
Equations [-@eq-mean-linear-combination-rv] and [-@eq-variance-linear-combination-ind-rv] are used in the next section.
