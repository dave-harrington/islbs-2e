...
countries <- mort_ed_owd |> 
  filter(Year == 2020) |> 
  rename(c_mortality= observation_value__indicator_child_mortality_rate__sex_total__wealth_quintile_total__unit_of_measure_deaths_per_100_live_births) |> 
...
**Data journalism**.  Data journalism frequently makes use of animation and interaction in combination with static visualizations to communicate narratives in an engaging way. Share an example of an article that uses an animated/interactive visualization and your reactions: What were your favorite aspects of the visualizations? How did the use of animation/interaction add to the impact of the story? Feel free to use one of the following links or find your own: ["Bussed out: How America moves its homeless"](https://www.theguardian.com/us-news/ng-interactive/2017/dec/20/bussed-out-america-moves-homeless-people-country-study?CMP=twt_gu), ["Where This Summer Was Relentlessly Hot"](https://www.nytimes.com/interactive/2023/10/09/world/hottest-summer-global-map.html), ["How a Vast Demographic Shift Will Reshape the World"](https://www.nytimes.com/interactive/2023/07/16/world/world-demographics.html), and ["Since When Have Trees Only Existed for Rich Americans?"](https://www.nytimes.com/interactive/2021/06/30/opinion/environmental-inequity-trees-critical-infrastructure.html)

**Bad visualizations**  Share a "bad" data visualization; i.e., one that is difficult to interpret and/or seems ineffective or misleading. Explain the main issue(s) with the visualization and comment on how you might improve it. Feel free to use one of the visualizations in these links or find your own: [the "Data is Ugly" Reddit](https://www.reddit.com/r/dataisugly/), [FlowingData's collection of "Ugly Charts"](https://flowingdata.com/category/visualization/ugly-visualization/), and [a list of "27 Worst Charts of All Time" compiled by *Business Insider*](https://www.businessinsider.com/the-27-worst-charts-of-all-time-2013-6).
  
**Story telling** Telling stories with data often makes use of both data visualizations and data summaries. Find a data story that interests you and assess whether you think summary statistics were used effectively in the telling of that story. Also, what is something you learned from the data story? [This page](https://www.juiceanalytics.com/writing/20-best-data-storytelling-examples) and [this page](https://gijn.org/stories/editors-pick-top-10-data-journalism-projects-from-2023/) link to some examples of data storytelling, but many more are available on websites like [The Pudding](https://pudding.cool/) and [Reuters](https://www.reuters.com/graphics/).

**Do no harm** The Urban Institute's *Do No Harm Guide* body of work consists of several guides that aim to encourage thoughtful approaches for collecting and communicating data. Check out either [Applying Equity Awareness in Data Visualization](https://www.urban.org/sites/default/files/publication/104296/do-no-harm-guide.pdf) or [Centering Accessibility in Data Visualization](https://www.urban.org/sites/default/files/2022-12/Do%20No%20Harm%20Guide%20Centering%20Accessibility%20in%20Data%20Visualization.pdf). Share one idea/example that resonated with you and comment on how this might influence how you approach making visualizations in contexts outside of this class (e.g., such as when working in your field of interest).
