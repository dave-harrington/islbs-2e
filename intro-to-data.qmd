...
*JV: can you edit this image to change `All Variables` to `Variables in this text` or something similar?*
...
*plot does not center, at least in html.  Perhaps a conflict with a CSS file*
...
#|     positive associations and the second row shows negative associations. 
